# 📘 BA-Kit: Mật Mã Phản Trọng Lực (The Antigravity Codex v2.6.0)
...
Biệt đội chia sẻ một "Bộ nhớ Chiến dịch" thông qua `CONTINUITY.md` (được tạo từ `templates/continuity_template.md`).
...
1.  Copy `templates/continuity_template.md` ra thư mục gốc thành `CONTINUITY.md`.
