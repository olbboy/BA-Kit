...
BA-Kit dùng 26 agents chuyên biệt, mỗi agent giỏi 1 lĩnh vực, phối hợp qua handoff protocol. / BA-Kit uses 26 specialized agents, each expert in one area, collaborating through a structured handoff protocol.
